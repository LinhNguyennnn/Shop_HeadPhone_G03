...
namespace HP_PLConsole
{
    public class ConsoleTable
    {
        ...
        public void Write(Format format = HP_PLConsole.Format.Default)
        {
            switch (format)
            {
                case HP_PLConsole.Format.Default:
                    Console.WriteLine(ToString());
                    break;
                case HP_PLConsole.Format.MarkDown:
                    Console.WriteLine(ToMarkDownString());
                    break;
                case HP_PLConsole.Format.Alternative:
                    Console.WriteLine(ToStringAlternative());
                    break;
                case HP_PLConsole.Format.Minimal:
